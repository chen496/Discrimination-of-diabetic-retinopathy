  ...
  for(sample_i in 1:nrow(X)){
    ...
    temp_Y<-Y[-sample_i]
     ...
     # test_pred.Prob[sample_i]<-predict(glm.fit,s="lambda.min",test_X,type=predict_type)
      ...
      write.csv(a,file=paste0("glm_Valid_pred.Prob_sample",sample_i,".csv"))
      saveRDS(final_glm.fit,file=paste0("glm_HC_DR_best_model_sample",sample_i,".rds"))
  }
  
      write.csv(Valid_pred.Prob,file=("glm_Valid_pred.Prob.csv"))
...
write.csv(Pred.Prob,file=paste0("glm_HC_DR_test_prob.csv"))
write.csv(SS,file=paste0("glm_HC_DR_test_TPR_TNR.csv"))
write.csv(TP_FP_FN_TN,file=paste0("glm_HC_DR_test_TP_FP_FN_TN.csv"))


write.csv(SS_Valid_pred.Prob,file=paste0("glm_HC_DR_valid_prob.csv"))
write.csv(SS_Valid,file=paste0("glm_HC_DR_rounds_valid_TPR_TNR.csv"))
write.csv(SS_Valid_TP_FP_FN_TN,file=paste0("glm_HC_DR_valid_TP_FP_FN_TN.csv"))
write.csv(M,file=paste0("glm_HC_DR_CVmodel.rds"))
